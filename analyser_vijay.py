...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Simple_PySide_Base/icons/16x16/cil-magnifying-glass.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.Keyword_box.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignVCenter)
...
"}")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(0, 0, 121, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../Simple_PySide_Base/icons/16x16/cil-magnifying-glass.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap("../Simple_PySide_Base/icons/16x16/cil-reload.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap("../Simple_PySide_Base/icons/16x16/cil-magnifying-glass.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        self.frame_5.setGeometry(QtCore.QRect(360, 720, 121, 81))
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_5)
        self.pushButton_4.setGeometry(QtCore.QRect(0, 0, 121, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
...
"}")
    ...
    def draw(self):
            ...
            y = np.random.normal(size=(3,3000))
            for i in range(3):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Keyword_box.setPlaceholderText(_translate("MainWindow", "Keyword"))
        self.pushButton.setText(_translate("MainWindow", "Top +ve/-ve "))
        self.pushButton_2.setText(_translate("MainWindow", "Region"))
        self.pushButton_3.setText(_translate("MainWindow", "Age"))
